 ...
 *
 * ResourceLoader接口的默认实现。被ResourceEditor使用，并且作为AbstractApplicationContext
 * 的基类使用，也可以单独使用。
 *
 ...
 *
 * 将返回一个UrlResource如果地址是URL,如果它是一个非URL的路径或一个"classpath:"的伪URL。
...
public class DefaultResourceLoader implements ResourceLoader {
	 ...
	 *
	 * 返回用于加载类路径资源的类加载器。
	 * 将被转递给ClassPathResource的构造器用于所有被这个资源加载器创建的所有ClassPathResource。
	 */
	@Override
	 ...
	 *
	 * 通过实现ContextResource接口显式地表达一个上下文相关的路径的ClassPathResource。
	 */
